        ...
        <div className="text-white">
          ...
          <ul className="list-disc list-inside mb-8">
            <li className="flex items-center space-x-4">
              <Image width="fill" height="fill" src={HouseIcon} alt="House Icon" className="w-8 h-8" />
              <span>Spacious and comfortable living spaces</span>
            </li>
            <li className="flex items-center space-x-4 my-10">
              <Image width="fill" height="fill" src={LocationIcon} alt="Location Icon" className="w-8 h-8" />
              <span>Located in prime areas with excellent infrastructure</span>
            </li>
            <li className="flex items-center space-x-4 my-10">
              <Image width="fill" height="fill" src={MoneyIcon} alt="Money Icon" className="w-8 h-8" />
