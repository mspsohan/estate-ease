          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <Image width="fill" height="fill" className="w-full h-48 object-cover object-center" src={Imagee} alt="Service 1" />
                <div className="p-4">
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <Image width="fill" height="fill" className="w-full h-48 object-cover object-center" src={Imageee} alt="Service 2" />
                <div className="p-4">
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <Image width="fill" height="fill" className="w-full h-48 object-cover object-center" src={Imageeee} alt="Service 3" />
                <div className="p-4">
